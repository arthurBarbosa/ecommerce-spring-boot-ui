...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // read the user's email address from address from browser storage
  ...
  onSubmit() {
    ...
    */
    ...
    let ordeItems: OrderItem[] = cartItems.map(tempCartItem => new OrderItem(tempCartItem));
